...
static struct dsi_cmd_desc cabc_user_interface_image_sequence[] = {
	{ DTYPE_DCS_WRITE1, 1, 0, 0, 10, sizeof(cabc_user_interface_image), cabc_user_interface_image },
	{ DTYPE_DCS_WRITE, 1, 0, 0, 10, sizeof(display_on), display_on },
};

static struct dsi_cmd_desc cabc_still_image_sequence[] = {
	{ DTYPE_DCS_WRITE1, 1, 0, 0, 10, sizeof(cabc_still_image), cabc_still_image },
	{ DTYPE_DCS_WRITE, 1, 0, 0, 10, sizeof(display_on), display_on },
};

static struct dsi_cmd_desc cabc_video_image_sequence[] = {
	{ DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(cabc_min_brightness), cabc_min_brightness },
	{ DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(cabc_movie_bl_ctr), cabc_movie_bl_ctr },
	{ DTYPE_DCS_WRITE1, 1, 0, 0, 10, sizeof(cabc_video_image), cabc_video_image },
	{ DTYPE_DCS_WRITE, 1, 0, 0, 10, sizeof(display_on), display_on },
};
#endif
...
static struct dsi_cmd_desc cmd_mipi_initial_sequence[] = {
	...
	{ DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(differ), differ },
	{ DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(nvm_black), nvm_black },
	{ DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(nvm_disable), nvm_disable },
	{ DTYPE_GEN_LWRITE, 1, 0, 0, 10, sizeof(color_enhance), color_enhance },
	{ DTYPE_DCS_WRITE, 1, 0, 0, 80, sizeof(sleep_out), sleep_out },
	{ DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(brightness_setting_N1), brightness_setting_N1 },
	{ DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(bkl_control_N1), bkl_control_N1 },
	{ DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(cabc_control), cabc_control },
	{ DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(te_out), te_out },
	{ DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(tear_scan), tear_scan },
	{ DTYPE_DCS_WRITE, 1, 0, 0, 0, sizeof(display_on), display_on },
};

static struct dsi_cmd_desc cmd_mipi_off_sequence[] = {
	{ DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(protect_off), protect_off },
	{ DTYPE_GEN_LWRITE, 1, 0, 0, 10, sizeof(nvm_black), nvm_black },
	{ DTYPE_GEN_LWRITE, 1, 0, 0, 10, sizeof(nvm_disable), nvm_disable },
	{ DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(protect_on), protect_on },
	{ DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(te_off), te_off },
	{ DTYPE_GEN_LWRITE, 1, 0, 0, 10, sizeof(display_off), display_off },
...
static int __devinit mipi_orise_lcd_probe(struct platform_device *pdev)
{
	...
	if (pdev->id == 0) {
		...
		if (mipi_orise_pdata && mipi_orise_pdata->phy_ctrl_settings)
