...
static struct single_row_lut oppo_fcc_temp = {
	.x		= {-20, 0, 25, 40, 60},
	.y		= {2530, 2531, 2509, 2457, 2512},
	.cols	= 5
};

static struct single_row_lut oppo_fcc_sf = {
	.x		= {0},
	.y		= {100},
	.cols	= 1
};

static struct sf_lut oppo_rbatt_sf = {
	.rows		= 28,
	.cols		= 5,
	/* row_entries are temperature */
	.row_entries	= {-20, 0, 25, 40, 60},
...
static struct pc_temp_ocv_lut oppo_pc_temp_ocv = {
	.rows		= 24,
	.cols		= 5,
	.temp		= {-20, 0, 25, 40, 60},
	.percent	= {100, 95, 90, 85, 80, 75, 70, 65, 60, 55, 50, 45, 40,
					35, 30, 25, 22, 19, 16, 13, 10, 7, 4, 1},
	.ocv		= {
				{4330, 4329, 4303, 4281, 4301},
				{4233, 4251, 4237, 4219, 4239},
				{4161, 4189, 4181, 4164, 4183},
...
struct bms_battery_data OPPO_palladium_2500mAh_data = {
	.fcc			= 2500,
	.fcc_temp_lut		= &oppo_fcc_temp,
	.fcc_sf_lut		= &oppo_fcc_sf,
	.pc_temp_ocv_lut	= &oppo_pc_temp_ocv,
	.rbatt_sf_lut		= &oppo_rbatt_sf,
	.default_rbatt_mohm	= 184,
};
#endif
